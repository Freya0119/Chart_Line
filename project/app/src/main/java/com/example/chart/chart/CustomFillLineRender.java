...
public class CustomFillLineRender extends LineChartRenderer {
    public CustomFillLineRender(LineDataProvider chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
